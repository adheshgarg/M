...
public:
     ...
     void admindist(string user,string searc,int q)
       {
           user=user+".csv";
           int x,y,pu;
          fstream fp,tp,pt;
   ...
   private:
    ...
    public:
        ...
        void create()
            ...
            getline(cin,number);
             cout<<"Enter the expiry of the medicine in the form dd/mm/yyyy"<<endl;
             cin>>d;
             while(1)
             {
             if ( cin.get() != '/' )
...

    {
        ...
        cout<<"enter the quantity of medicine to add"<<endl;
        cin>>q;
        y = pu+q;
        ostringstream str1;
        str1 << y<<',';
     ...
     void adddist()
      {
        ...
        cout<<"Enter the unique number of district of format D-Num"<<endl;
        while(i<6)
        {
          num[i]=getch();
          cout<<"&";
...
public:
   Admin ad;
    ...
    while(1)
    {
    cout<<"Create the username of shop"<<endl;
    cin>>username;
    ...
    {
    fp<<Id<<','<<name<<','<<username<<','<<password<<','<<dist<<endl;
    fj<<unique<<endl;
    fq<<username<<endl;
    }
    fp.close();
...
cin>>l;
  switch(l)
  {
    case 1:
    {
      cout<<"1. Register as a new user"<<endl<<"2. Log into registered user "<<endl<<"3. Go to previous menu"<<endl;
      cin>>o;
      switch(o)
      {
        case 1:
  ...
  case 2:
  {
    cout<<"1.Enter new district"<<endl<<"2.Epidermic status"<<endl;
    int choice;
    cin>>choice;
    switch(choice)
    {
